...
async function main() {
  ...
  // Only reflects this run's pre-merge cache - merging against `data`
  // afterward can change whether a DOHMH-invalid restaurant counts as
  // resolved. Pass those restaurants along so merge can correct it.
