...
- **Search radius:** drop a point on the map and the list, stats, and chart re-scope to a 0.25 / 0.5 / 1 mile circle around it instead of the whole map view. Each card in the list gains a distance field.
