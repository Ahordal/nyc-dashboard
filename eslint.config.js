...
export default tseslint.config(
  ...
  // --- src/: the browser-side React + TypeScript dashboard ---
  {
    ...
    rules: {
      ...
      // refs, etc.) that flags plenty of normal, working React
      ...
      // comments at each usage in MapView.tsx) -- downgraded to a
      // warning rather than disabled outright, so new `any` usage still
      // gets flagged for a second look.
