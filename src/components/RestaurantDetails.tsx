...
const GRADE_PENDING_NOTES: Record<
  string,
  string
> = {
  ...
  <InfoPopupContent
    overview={
      <ul>
        ...
        <li>
          Each Inspection History row represents a separate inspection.
        </li>
      </ul>
    }
    howToUse={
      <ul>
        ...
        <li>
          Select an Inspection History row to open that inspection&apos;s
          full report.
        </li>

        <li>
          Use the Google Street View link to open available street-level
          imagery in a new tab.
        </li>
      </ul>
    }
    grades={
    ...
    dataNotes={
      <ul>
        <li>
          Google Street View links automatically snap to the nearest
          available street-level imagery for the location. Photos are
          provided directly by Google Maps and may not reflect the
          restaurant&apos;s current storefront, facade, or business
          operations.
        </li>
      </ul>
    }
                ...
                (event) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="inspection-row-score">
                        {event.score}
                      </span>
                    </li>
                  );
