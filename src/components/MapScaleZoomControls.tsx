...
//
// Custom scale/zoom controls: a top-left zoom in/out pair (replacing
// esri/widgets/Zoom), and bottom-left Map Scale / Zoom Level readouts,
// each click-to-edit to jump straight to a value.
